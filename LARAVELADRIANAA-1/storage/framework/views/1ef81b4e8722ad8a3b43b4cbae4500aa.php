...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/cloning')); ?>" class="list-group-item list-group-item-action bg-body-tertiary">
            Tugas (Bootstrap Cloning)
        </a>
        </div>
...
<?php /**PATH C:\Users\ACER\rianalaravel\resources\views/routing.blade.php ENDPATH**/ ?>